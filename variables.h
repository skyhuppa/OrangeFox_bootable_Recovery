...
#define FOX_MAGISK_UNINSTALLER "unrootmagisk.zip"

#define FOX_PASS_IN_PERSIST "/persist/.fsec"

#define FOX_PRE_ROM_FLASH_SCRIPT "/sbin/pre_rom_flash.sh"
#define FOX_POST_ROM_FLASH_SCRIPT "/sbin/post_rom_flash.sh"
